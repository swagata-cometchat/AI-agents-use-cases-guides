...
> Create a Mastra agent that classifies workplace HR concerns, assigns urgency, routes to the correct HR tier (generalist, specialist, emergency, or human rep), and supports compliant handoff — then connect it to CometChat.
...
- Multi‑tier routing: generalist → specialist → emergency → human.
...
- CometChat AI Agent integration for in‑chat HR help & escalation triggers.
...
- **Project README**: [README.md](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/README.md)
- **Main agent**: [index.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/index.ts) (hrIssueCheckerAgent)
- **Routing logic**: [hr-issue-checker-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/hr-issue-checker-agent.ts)
- **Specialist agents**: [*.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/*.ts)
- **Workflow**: [hr-issue-workflow.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/workflows/hr-issue-workflow.ts)
- **Tool (assessment)**: [hr-issue-checker-tool.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/tools/hr-issue-checker-tool.ts) (if present)
...
7. A workflow (`hr-issue-workflow`) demonstrates how to wrap the assessment in a composed step sequence (currently single step — extendable).

Key components:
- Agent registration: [index.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/index.ts)
- Routing decision engine: [hr-issue-checker-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/hr-issue-checker-agent.ts)
- Supporting tier agents: [*.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents)
- Workflow container: [hr-issue-workflow.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/workflows/hr-issue-workflow.ts)
...
- Runtime & config
  - [package.json](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/package.json), [tsconfig.json](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/tsconfig.json), [README.md](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/README.md)
- Agents
  - [hr-issue-checker-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/hr-issue-checker-agent.ts) (core triage)
  - [hr-generalist-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/hr-generalist-agent.ts)
  - [hr-specialist-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/hr-specialist-agent.ts)
  - [emergency-hr-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/emergency-hr-agent.ts)
  - [hr-human-rep-agent.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/agents/hr-human-rep-agent.ts)
- Workflow
  - [hr-issue-workflow.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/workflows/hr-issue-workflow.ts)
- Tool
  - [hr-issue-checker-tool.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/tools/hr-issue-checker-tool.ts)
- Mastra init
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/enterprise-AI-Agent/blob/main/HR-issues-human-handoff-agent/src/mastra/index.ts)
...
- Emergency keywords → immediate critical escalation
- Specialist keywords → high priority escalation
...
<Steps>
  ...
  <Step title="Escalation correctness">Emergency issues always → critical emergency.</Step>
...
- Add secondary validation step to double‑check emergency classification.
...
- Localize responses for multi‑region teams.
