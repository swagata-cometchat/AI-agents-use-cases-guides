...
- **Project README**: [README.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/README.md)
- **Agent**: [src/mastra/agents/travel-faq-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/src/mastra/agents/travel-faq-agent.ts)
- **Tool**: [src/mastra/tools/docs-retriever.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/src/mastra/tools/docs-retriever.ts)
- **Knowledge base**: [knowledge/travel/](https://github.com/swagata-cometchat/travel-AI-Agent/tree/main/travel-faq-agent/knowledge/travel)
...
- Knowledge Base
  - [knowledge/travel/baggage-policies-guide.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/knowledge/travel/baggage-policies-guide.md)
  - [knowledge/travel/check-in-procedures-guide.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/knowledge/travel/check-in-procedures-guide.md)
  - [knowledge/travel/cancellations-rebooking-guide.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/knowledge/travel/cancellations-rebooking-guide.md)
  - [knowledge/travel/general-travel-faq.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/knowledge/travel/general-travel-faq.md)
- Agent & Tools
  - [src/mastra/agents/travel-faq-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/src/mastra/agents/travel-faq-agent.ts)
  - [src/mastra/tools/docs-retriever.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/src/mastra/tools/docs-retriever.ts)
  - [src/mastra/tools/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/src/mastra/tools/index.ts)
- Runtime
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/src/mastra/index.ts)
  - [package.json](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/package.json), [tsconfig.json](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/tsconfig.json), [README.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/travel-faq-agent/README.md)
