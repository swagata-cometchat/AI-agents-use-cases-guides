...
- **Project README**: [README.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/README.md)
- **Primary agent**: [src/mastra/agents/vip-request-escalation-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/vip-request-escalation-agent.ts)
- **Specialists**: [concierge-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/concierge-agent.ts), [senior-concierge-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/senior-concierge-agent.ts), [vip-manager-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/vip-manager-agent.ts), [human-rep-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/human-rep-agent.ts)
- **Tool**: [src/mastra/tools/vip-request-tool.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/tools/vip-request-tool.ts)
- **Workflow**: [src/mastra/workflows/vip-request-workflow.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/workflows/vip-request-workflow.ts)
- **Mastra init**: [src/mastra/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/index.ts)
...
- Runtime & Config
  - [package.json](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/package.json), [tsconfig.json](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/tsconfig.json), [README.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/README.md)
- Agents
  - [agents/vip-request-escalation-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/vip-request-escalation-agent.ts) (primary)
  - [agents/concierge-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/concierge-agent.ts)
  - [agents/senior-concierge-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/senior-concierge-agent.ts)
  - [agents/vip-manager-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/vip-manager-agent.ts)
  - [agents/human-rep-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/agents/human-rep-agent.ts)
- Tools
  - [tools/vip-request-tool.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/tools/vip-request-tool.ts)
  - [tools/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/tools/index.ts)
- Workflows
  - [workflows/vip-request-workflow.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/workflows/vip-request-workflow.ts)
- Bootstrap
  - [mastra/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/vip-requests-human-handoff-agent/src/mastra/index.ts)
***
