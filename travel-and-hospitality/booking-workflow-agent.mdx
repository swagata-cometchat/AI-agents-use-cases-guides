...
- **Project README**: [README.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/README.md)
...
Key components:
- Agent: [src/mastra/agents/booking-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/agents/booking-agent.ts)
- Tools: [src/mastra/tools/booking-tools.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/tools/booking-tools.ts), [src/mastra/tools/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/tools/index.ts)
- Routes: [src/mastra/server/routes/booking.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/server/routes/booking.ts)
- Server registration: [src/mastra/server/routes.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/server/routes.ts), [src/mastra/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/index.ts)
- Types & schemas: [src/types/booking.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/types/booking.ts)
...
- Runtime & config
  - [package.json](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/package.json), [tsconfig.json](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/tsconfig.json), [README.md](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/README.md)
- Agents
  - [src/mastra/agents/booking-agent.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/agents/booking-agent.ts)
- Tools
  - [src/mastra/tools/booking-tools.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/tools/booking-tools.ts)
  - [src/mastra/tools/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/tools/index.ts)
- Server
  - [src/mastra/index.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/index.ts)
  - [src/mastra/server/routes.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/server/routes.ts)
  - [src/mastra/server/routes/booking.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/server/routes/booking.ts)
  - [src/mastra/server/util/safeErrorMessage.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/mastra/server/util/safeErrorMessage.ts)
- Types
  - [src/types/booking.ts](https://github.com/swagata-cometchat/travel-AI-Agent/blob/main/booking-workflow-agent/src/types/booking.ts)
